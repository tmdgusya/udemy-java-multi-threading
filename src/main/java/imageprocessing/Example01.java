...
public class Example01 {
    ...
    public static final String DESTINATION_FILE = "./src/main/resources/flowers-out.jpg";
...
//        recolorSingleThreaded(originalImage, resultImage);
        recolorMultiThread(originalImage, resultImage, 4); // 6개 넘어가면 SingleThread 에 비해 내컴 기준 느려지는거 같음.
